...
import { github, live } from "@src/assets/images";
...
const ProjectCard: FC<Props> = ({
  ...
  return (
    ...
    >
      <div className="w-full h-full bg-text-400 p-[1px] pl-[3px] rounded-[1.25rem] shadow-card ease-in-out duration-100 hover:bg-conversion-01 hover:-translate-y-1">
        <div className="bg-text-100 h-full rounded-[1.25rem] py-3 px-4 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 flex-1">
            <Typography
              ...
              type="bold"
              variant="p"
              className="text-text-500 text-justify"
            >
              {description}
            </Typography>
