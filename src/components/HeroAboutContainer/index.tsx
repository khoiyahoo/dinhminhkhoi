    ...
    <div className="flex justify-center items-center flex-col md:flex-row pb-12 gap-8">
      <div className="w-full md:w-1/2">
        <div className="flex items-center">
          <Lottie animationData={catHello} loop={true} className="w-20 h-20" />
          <Typography
            size="normal"
            type="bold"
            variant="h2"
        ...
        <Typography
          ...
          type="bold"
          variant="p"
          className="mt-2 glitch text-text-100 text-lg text-justify"
        >
      ...
      <div className="w-full rounded-lg border border-orange-100 p-4 md:w-auto">
